...
function Footer() {
  ...
  return (
    <div className="flex justify-between" id="footer-responsive">

      <div className="flex flex-col w-1/5" id="item-footer-responsive">
      ...
      <div className="flex flex-col gap-2 w-1/5" id="item-footer-responsive">
